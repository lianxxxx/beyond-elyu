...
const LANDMARKS: Landmark[] = [
  { place: "Inabel Weaving", town: "Bangar" },
  ...
  { place: "Gapuz Grape Farm", town: "Bauang" },
  { place: "Windswept points", town: "Caba" },
  { place: "Gallano Rice Terraces", town: "Aringay" },
  { place: "Agoo Basilica", town: "Agoo" },
  { place: "Southern shore", town: "Santo Tomas" },
  { place: "Seaside Camping", town: "Rosario" },
  { place: "Bilagan Road", town: "Sudipen" },
  { place: "Balay Anito Falls", town: "Santol" },
  { place: "Tangadan Falls", town: "San Gabriel" },
  { place: "Dupagan Falls", town: "San Gabriel" },
  { place: "Balili River rock formation", town: "Naguilian" },
  { place: "Bulalakaw Falls", town: "Bagulin" },
  { place: "Libtong Lake", town: "Burgos" },
  { place: "Lang-ay Falls", town: "Tubao" },
  { place: "PUGAD", town: "Pugo" },
];
